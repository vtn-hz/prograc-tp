...
/**
 * Decorador concreto que representa un médico con postgrado de magister.
...
public class DecoratorMedicoPostgradoMagister extends DecoratorMedicoPostgrado {
    ...
    /**
     * Constructor del decorador de postgrado tipo magister.
     *
    ...
    /**
     * Retorna el honorario del médico ajustado según su postgrado de magister.
     ...
     *
     * @return honorario total del médico con postgrado de magister
     */
	@Override
